...
class TestKassapaate(unittest.TestCase):
    ...
    def test_lataus_lisaa_kortin_saldoa_jos_summa_positiivinen(self):
    ...
    def test_lataus_ei_tee_mitaan_jos_summa_negatiivinen(self):
        maksukortti_mock = Mock(wraps=Maksukortti(5))
        self.kassa.lataa(maksukortti_mock, -1)
        maksukortti_mock.lataa.assert_not_called()

    def test_lataus_ei_tee_mitaan_jos_summa_nolla(self):
        maksukortti_mock = Mock(wraps=Maksukortti(5))
